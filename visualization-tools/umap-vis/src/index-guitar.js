...
const TIME_BAR_SECTIONS = ['timeSect0', 'timeSect1', 'timeSect2', 'timeSect3', 'timeSect4',
                        'timeSect5', 'timeSect6', 'timeSect7', 'timeSect8', 'timeSect9', 'timeSect10', 'timeSect11', 'timeSect12', 'timeSect13'];
...
const umap = new UMAP(container, window.location.origin + "/data/guitar-combined.csv");
